    ...
    <div class="image-box" ref="imageBox">
      <swiper :options="swiperOption">
        ...
        <swiper-slide class="slide">
          <progressive-img class="__img" :src="image1H(evento)" :placeholder="evento.imageL1" :aspect-ratio="2/3"/>
        </swiper-slide>

        <swiper-slide class="slide" v-if="ifImage2">
          <progressive-img class="__img" :src="image2H(evento)" :placeholder="evento.imageL1" :aspect-ratio="2/3"/>
        </swiper-slide>

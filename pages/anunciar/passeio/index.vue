...
export default {
  ...
  computed: {
    ...
    form1ok () {
      return this.$store.state.passeioData.tipoPasseio !== null ? 'background:#64B5F6;cursor:pointer' : ''
    },
    form2ok () {
      return this.$store.state.passeioData.capacidade !== null ? 'background:#64B5F6;cursor:pointer' : ''
    },
    form3ok () {
      return this.$store.state.passeioData.duracao !== null ? 'background:#64B5F6;cursor:pointer' : ''
    },
    form4ok () {
      return this.$store.state.passeioData.localSaida !== null && this.$store.state.passeioData.localSaida !== 'Outro' ? 'background:#64B5F6;cursor:pointer'
      : this.localSaida !== '' ? 'background:#64B5F6;cursor:pointer' 
      : ''
    },
    form5ok () {
      return 1<2 ? 'background:#64B5F6;cursor:pointer' : ''
    },
    form6ok () {
      return this.$store.state.passeioData.valorPasseio !== 0 ? 'background:#64B5F6;cursor:pointer' : ''
    },
    form7ok () {
      return this.imageURL1 !== null ? 'background:#64B5F6;cursor:pointer' : ''
    },
    form8ok () {
      return this.$store.state.passeioData.title !== '' ? 'background:#64B5F6;cursor:pointer' : ''
    },
    form9ok () {
      return this.$store.state.passeioData.subtitle !== '' ? 'background:#64B5F6;cursor:pointer' : ''
    },
    form10ok () {
      return this.$store.state.passeioData.celular.length === 15 ? 'background:#64B5F6;cursor:pointer' : ''
    },
    form11ok () {
      return 1<2 ? 'background:#64B5F6;cursor:pointer' : ''
    }

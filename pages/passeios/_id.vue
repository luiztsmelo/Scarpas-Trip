    ...
    <div class="image-box" ref="imageBox">
      <swiper :options="swiperOption">
        ...
        <swiper-slide class="slide">
          <progressive-img class="__img" :src="image1H(passeio)" :placeholder="passeio.imageL1" :aspect-ratio="2/3"/>
        </swiper-slide>

        <swiper-slide class="slide" v-if="ifImage2">
          <progressive-img class="__img" :src="image2H(passeio)" :placeholder="passeio.imageL2" :aspect-ratio="2/3"/>
        </swiper-slide>
